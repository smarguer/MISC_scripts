...
# print "$count\n";
 ...
 if ($holder[5] eq "CH1_bases")
 {
  ...
  print OUT "chr1\t$coord[0]\t$coord[1]\t$count;$flag1;$flag2;$holder[1];$holder[2];$holder[3];$holder[4];$holder[8];$holder[9];$holder[10];$holder[11];$holder[12]\t500\t$holder[8]\n";
 }
 elsif ($holder[5] eq "CH2_bases")
 {
  ...
  print OUT "chr2\t$coord[0]\t$coord[1]\t$count;$flag1;$flag2;$holder[1];$holder[2];$holder[3];$holder[4];$holder[8];$holder[9];$holder[10];$holder[11];$holder[12]\t500\t$holder[8]\n";
 }
 elsif ($holder[5] eq "CH3_bases")
 {
  ...
  print OUT "chr3\t$coord[0]\t$coord[1]\t$count;$flag1;$flag2;$holder[1];$holder[2];$holder[3];$holder[4];$holder[8];$holder[9];$holder[10];$holder[11];$holder[12]\t500\t$holder[8]\n";
 }
 elsif ($holder[5] eq "CH4_bases")
 {
  ...
  print OUT "chr4\t$coord[0]\t$coord[1]\t$count;$flag1;$flag2;$holder[1];$holder[2];$holder[3];$holder[4];$holder[8];$holder[9];$holder[10];$holder[11];$holder[12]\t500\t$holder[8]\n";
 }
 elsif ($holder[5] eq "CH5_bases")
 {
  ...
  print OUT "chr5\t$coord[0]\t$coord[1]\t$count;$flag1;$flag2;$holder[1];$holder[2];$holder[3];$holder[4];$holder[8];$holder[9];$holder[10];$holder[11];$holder[12]\t500\t$holder[8]\n";
 }
 elsif ($holder[5] eq "CH6_bases")
 {
  ...
  print OUT "chr6\t$coord[0]\t$coord[1]\t$count;$flag1;$flag2;$holder[1];$holder[2];$holder[3];$holder[4];$holder[8];$holder[9];$holder[10];$holder[11];$holder[12]\t500\t$holder[8]\n";
 }
