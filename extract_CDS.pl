...
open (OUT, '>c:\\make_gff_IV.txt')or die 'could not open the output file';
...
my $seqio_obj1 = Bio::SeqIO->new (-file =>"C:\\chromosome1.020508.contig" , -format => "embl");
my $seqio_obj2 = Bio::SeqIO->new (-file =>"C:\\chromosome2.020508.contig" , -format => "embl");
my $seqio_obj3 = Bio::SeqIO->new (-file =>"C:\\chromosome3.020508.contig" , -format => "embl");
