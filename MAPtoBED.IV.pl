...
# print "$count\n";
 ...
 {
  $chr1{$coord[0]}{$holder[1]}="$coord[0]\t$coord[1]\t$holder[1]\t1\t$holder[8]\n";
 }
 elsif ($holder[5] eq "CH2_bases")
 {
  $chr2{$coord[0]}{$holder[1]}="$coord[0]\t$coord[1]\t$holder[1]\t1\t$holder[8]\n";
 }
 elsif ($holder[5] eq "CH3_bases")
 {
  $chr3{$coord[0]}{$holder[1]}="$coord[0]\t$coord[1]\t$holder[1]\t1\t$holder[8]\n";
 }
 elsif ($holder[5] eq "MIT_bases")
 {
  $chr4{$coord[0]}{$holder[1]}="$coord[0]\t$coord[1]\t$holder[1]\t1\t$holder[8]\n";
 }
 elsif ($holder[5] eq "MAT_bases")
 {
  $chr5{$coord[0]}{$holder[1]}="$coord[0]\t$coord[1]\t$holder[1]\t1\t$holder[8]\n";
 }
 elsif ($holder[5] eq "TEL_bases")
 {
  $chr6{$coord[0]}{$holder[1]}="$coord[0]\t$coord[1]\t$holder[1]\t1\t$holder[8]\n";
 }
